...
{   require 'credentials.php';
    ...
    {   
            ...
            $queryis1 = "UPDATE orders SET `cid`='$id' where Purpose ='$purpose' and Tbltyp ='$tble' ";
            if (mysqli_query($conn,$queryis1)) 
            {
...
{   require 'credentials.php';
    ...
    { 
        ...
        $query1="insert into `data table` select tablebook.*, orders.Menu FROM tablebook LEFT JOIN orders ON tablebook.id = orders.cid";
