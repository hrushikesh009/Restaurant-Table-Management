...
@page { margin: 0; }
        ...
        <header>
			...
			<address >
				<p>The Kitchen</p>
                                <p>F-702,<br> Sarita Vihar,<br> Virar 401303</p>
				<p>(+91) 7057629987</p>
			</address>
		...
		<article>
			...
			<table >
					...
					<tr> 
						<td>Customer Places : -  <?php echo $country; ?> </td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- hrushimalpekar1999@gmail.com || Web :- www.thekitchen.com || Phone :- +91 7057629987  </p>
			</div>
		</aside>
	</body>
</html>
